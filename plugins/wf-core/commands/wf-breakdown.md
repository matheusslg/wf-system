...
First, check if project has Figma configured via `/wf-core:wf-design-setup`:
...
---
*Breakdown generated by breakdown via `/wf-core:wf-breakdown`*
```
...
---
*Generated by breakdown via `/wf-core:wf-breakdown`*
```
...
# Execute a sub-task
/wf-core:wf-delegate {child_number}
```
```
...
# Check progress
/wf-core:wf-ticket-status {reference}
...
Then run `/wf-core:wf-breakdown` again.
```
...
```bash
# From Jira ticket
/wf-core:wf-breakdown PROJ-1023
/wf-core:wf-breakdown https://gnarlysoft.atlassian.net/browse/PROJ-1023

# From GitHub issue
/wf-core:wf-breakdown #42
/wf-core:wf-breakdown 42
/wf-core:wf-breakdown https://github.com/owner/repo/issues/42

# With flags
/wf-core:wf-breakdown #42 --dry-run
/wf-core:wf-breakdown PROJ-1023 --skip-figma
```

## Related Commands
- `/wf-core:wf-ticket-status` - Check implementation progress
- `/wf-core:wf-delegate` - Execute a specific sub-task with its agent
- `/wf-core:wf-implement` - Implement a feature directly (without source issue)
